	...
	wxPanel(parent, id)
{
	...
	for (int i = 0; i < (int)CONSTANT_SIZE::NUM_OF_SCL_IN_MT; ++i) {
		sclVector.push_back(new SpinCtrlLevel(this, (int)ID_MISC::ID_SPIN1 + i, buffer, 1));
	}
	...
	Bind(wxEVT_COMBOBOX, &MysteriousTeacher::BounceDDCHSelection, this, (int)ID_MISC::ID_DDCH);
	Bind(TRANSMIT_SCL_SELECTION, &MysteriousTeacher::BounceSCLSelection, this, (int)ID_MISC::ID_SPIN1, (int)ID_MISC::ID_SPIN2);
	Bind(wxEVT_COMBOBOX, &MysteriousTeacher::BounceDDCLSelection, this, (int)ID_MISC::ID_DDCL1, (int)ID_MISC::ID_DDCL3);
