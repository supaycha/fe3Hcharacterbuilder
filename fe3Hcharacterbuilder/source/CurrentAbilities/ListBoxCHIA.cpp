...
//
//ListBoxCHIA::ListBoxCHIA(wxWindow* panel, wxWindowID id, int x, int y, int x2, int y2, const wxArrayString& choices, long style) :
...
//}
//
//void ListBoxCHIA::ReceiveExclusivity(wxString charactername) {
//	currentDDCselection = charactername;
//	FilterAbilities();
//}
//
//void ListBoxCHIA::FilterAbilities() {
...
//}
//
//void ListBoxCHIA::ReceiveAbilityFiltration(std::vector<wxString> dirtynames) {
...
//}
//
//void ListBoxCHIA::repopulate() {
//	this->Set(ToArrayString(filteredAAnames));
//
//	reselection();
//}
//
//void ListBoxCHIA::reselection() {
...
//}
//
//wxArrayString ListBoxCHIA::ToArrayString(std::vector<wxString> names) {
