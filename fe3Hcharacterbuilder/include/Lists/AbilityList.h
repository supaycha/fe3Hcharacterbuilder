...
public:
	AbilityList() {
		...
		list.emplace_back(std::make_unique<SkillLevelAbility>(L"Authority Prowess Lv.2", L"Authority", SL::DPLUS, SKILLTYPE::AUTHORITY, WEAPONTYPE::BLANK, L"Grants Mt +4 with gambits.", false, STATTYPE::BLANK, ""));
		...
		list.emplace_back(std::make_unique<SkillLevelAbility>(L"Authority Prowess Lv.3", L"Authority", SL::CPLUS, SKILLTYPE::AUTHORITY, WEAPONTYPE::BLANK, L"Grants Mt +6 with gambits.", true, STATTYPE::GMIGHT, "5"));
		...
		list.emplace_back(std::make_unique<SkillLevelAbility>(L"Authority Prowess Lv.4", L"Authority", SL::BPLUS, SKILLTYPE::AUTHORITY, WEAPONTYPE::BLANK, L"Grants Mt +8 with gambits.", true, STATTYPE::MIGHT, "8"));
		list.emplace_back(std::make_unique<SkillLevelAbility>(L"Authority Prowess Lv.5", L"Authority", SL::APLUS, SKILLTYPE::AUTHORITY, WEAPONTYPE::BLANK, L"Grants Mt +10 with gambits.", true, STATTYPE::MIGHT, "10"));
		...
		list.emplace_back(std::make_unique<SkillLevelAbility>(L"Offensive Tactics", L"Authority", SL::SPLUS, SKILLTYPE::AUTHORITY, WEAPONTYPE::BLANK, L"Grants Mt +5 and Hit +20 with gambits.", false, STATTYPE::MIGHT, "5", STATTYPE::HIT, "20"));
