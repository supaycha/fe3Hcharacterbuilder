...
public:
	AbilityList() {
		...
		list.emplace_back(std::make_unique<SkillLevelAbility>(L"Sword Prowess Lv.4", L"Sword", SL::BPLUS, WEAPONTYPE::SWORD, L"Grants Hit +8, Avoid +16 and Critical Evade +8 when equipped with Sword", true, STATTYPE::HIT, "8", STATTYPE::AVO, "16", STATTYPE::CRITAVO, "8"));
		list.emplace_back(std::make_unique<SkillLevelAbility>(L"Sword Prowess Lv.5", L"Sword", SL::APLUS, WEAPONTYPE::SWORD, L"Grants Hit +10, Avoid +20 and Critical Evade +10 when equipped with Sword", true, STATTYPE::HIT, "10", STATTYPE::AVO, "20", STATTYPE::CRITAVO, "10"));
		...
		list.emplace_back(std::make_unique<SkillLevelAbility>(L"Lance Prowess Lv.1", L"Lance", SL::EPLUS, WEAPONTYPE::LANCE, L"Grants Hit +6, Avoid +6 and Critical Evade +5 when equipped with Lance", true, STATTYPE::HIT, "6", STATTYPE::AVO, "6", STATTYPE::CRITAVO, "5"));
		list.emplace_back(std::make_unique<SkillLevelAbility>(L"Lance Prowess Lv.2", L"Lance", SL::DPLUS, WEAPONTYPE::LANCE, L"Grants Hit +8, Avoid +8 and Critical Evade +6 when equipped with Lance", true, STATTYPE::HIT, "8", STATTYPE::AVO, "8", STATTYPE::CRITAVO, "6"));
		list.emplace_back(std::make_unique<SkillLevelAbility>(L"Lance Prowess Lv.3", L"Lance", SL::CPLUS, WEAPONTYPE::LANCE, L"Grants Hit +10, Avoid +10 and Critical Evade +7 when equipped with Lance", true, STATTYPE::HIT, "10", STATTYPE::AVO, "10", STATTYPE::CRITAVO, "7"));
		...
		list.emplace_back(std::make_unique<SkillLevelAbility>(L"Lance Prowess Lv.4", L"Lance", SL::BPLUS, WEAPONTYPE::LANCE, L"Grants Hit +12, Avoid +12 and Critical Evade +8 when equipped with Lance", true, STATTYPE::HIT, "12", STATTYPE::AVO, "12", STATTYPE::CRITAVO, "8"));
		list.emplace_back(std::make_unique<SkillLevelAbility>(L"Lance Prowess Lv.5", L"Lance", SL::APLUS, WEAPONTYPE::LANCE, L"Grants Hit +15, Avoid +15 and Critical Evade +10 when equipped with Lance", true, STATTYPE::HIT, "15", STATTYPE::AVO, "15", STATTYPE::CRITAVO, "10"));
		...
		list.emplace_back(std::make_unique<SkillLevelAbility>(L"Axe Prowess Lv.1", L"Axe", SL::EPLUS, WEAPONTYPE::AXE, L"Grants Hit +7, Avoid +5 and Critical Evade +5 when equipped with Axe", true, STATTYPE::HIT, "7", STATTYPE::AVO, "5", STATTYPE::CRITAVO, "5"));
		list.emplace_back(std::make_unique<SkillLevelAbility>(L"Axe Prowess Lv.2", L"Axe", SL::DPLUS, WEAPONTYPE::AXE, L"Grants Hit +10, Avoid +6 and Critical Evade +6 when equipped with Axe", true, STATTYPE::HIT, "10", STATTYPE::AVO, "6", STATTYPE::CRITAVO, "6"));
		list.emplace_back(std::make_unique<SkillLevelAbility>(L"Axe Prowess Lv.3", L"Axe", SL::CPLUS, WEAPONTYPE::AXE, L"Grants Hit +13, Avoid +7 and Critical Evade +7 when equipped with Axe", true, STATTYPE::HIT, "13", STATTYPE::AVO, "7", STATTYPE::CRITAVO, "7"));
		...
		list.emplace_back(std::make_unique<SkillLevelAbility>(L"Axe Prowess Lv.4", L"Axe", SL::BPLUS, WEAPONTYPE::AXE, L"Grants Hit +16, Avoid +8 and Critical Evade +8 when equipped with Axe", true, STATTYPE::HIT, "16", STATTYPE::AVO, "8", STATTYPE::CRITAVO, "8"));
		list.emplace_back(std::make_unique<SkillLevelAbility>(L"Axe Prowess Lv.5", L"Axe", SL::APLUS, WEAPONTYPE::AXE, L"Grants Hit +20, Avoid +10 and Critical Evade +10 when equipped with Axe", true, STATTYPE::HIT, "20", STATTYPE::AVO, "10", STATTYPE::CRITAVO, "10"));
		...
		list.emplace_back(std::make_unique<SkillLevelAbility>(L"Bow Prowess Lv.1", L"Bow", SL::EPLUS, WEAPONTYPE::BOW, L"Grants Hit +6, Avoid +6 and Critical Evade +5 when equipped with Bow", true, STATTYPE::HIT, "6", STATTYPE::AVO, "6", STATTYPE::CRITAVO, "5"));
		list.emplace_back(std::make_unique<SkillLevelAbility>(L"Bow Prowess Lv.2", L"Bow", SL::DPLUS, WEAPONTYPE::BOW, L"Grants Hit +8, Avoid +8 and Critical Evade +6 when equipped with Bow", true, STATTYPE::HIT, "8", STATTYPE::AVO, "8", STATTYPE::CRITAVO, "6"));
		...
		list.emplace_back(std::make_unique<SkillLevelAbility>(L"Bow Prowess Lv.3", L"Bow", SL::CPLUS, WEAPONTYPE::BOW, L"Grants Hit +10, Avoid +10 and Critical Evade +7 when equipped with Bow", true, STATTYPE::HIT, "10", STATTYPE::AVO, "10", STATTYPE::CRITAVO, "7"));
		list.emplace_back(std::make_unique<SkillLevelAbility>(L"Bow Prowess Lv.4", L"Bow", SL::BPLUS, WEAPONTYPE::BOW, L"Grants Hit +12, Avoid +12 and Critical Evade +8 when equipped with Bow", true, STATTYPE::HIT, "12", STATTYPE::AVO, "12", STATTYPE::CRITAVO, "8"));
		list.emplace_back(std::make_unique<SkillLevelAbility>(L"Bow Prowess Lv.5", L"Bow", SL::APLUS, WEAPONTYPE::BOW, L"Grants Hit +15, Avoid +15 and Critical Evade +10 when equipped with Bow", true, STATTYPE::HIT, "15", STATTYPE::AVO, "15", STATTYPE::CRITAVO, "10"));
		...
		list.emplace_back(std::make_unique<SkillLevelAbility>(L"Brawling Prowess Lv.1", L"Gauntlets", SL::EPLUS, WEAPONTYPE::GAUNTLETS, L"Grants Hit +5, Avoid +7 and Critical Evade +5 when brawling.", true, STATTYPE::HIT, "5", STATTYPE::AVO, "7", STATTYPE::CRITAVO, "5"));
		list.emplace_back(std::make_unique<SkillLevelAbility>(L"Brawling Prowess Lv.2", L"Gauntlets", SL::DPLUS, WEAPONTYPE::GAUNTLETS, L"Grants Hit +6, Avoid +10 and Critical Evade +6 when brawling", true, STATTYPE::HIT, "6", STATTYPE::AVO, "10", STATTYPE::CRITAVO, "6"));
		list.emplace_back(std::make_unique<SkillLevelAbility>(L"Brawling Prowess Lv.3", L"Gauntlets", SL::CPLUS, WEAPONTYPE::GAUNTLETS, L"Grants Hit +7, Avoid +13 and Critical Evade +7 when brawling", true, STATTYPE::HIT, "7", STATTYPE::AVO, "13", STATTYPE::CRITAVO, "7"));
		list.emplace_back(std::make_unique<SkillLevelAbility>(L"Brawling Prowess Lv.4", L"Gauntlets", SL::BPLUS, WEAPONTYPE::GAUNTLETS, L"Grants Hit +8, Avoid +16 and Critical Evade +8 when brawling", true, STATTYPE::HIT, "8", STATTYPE::AVO, "16", STATTYPE::CRITAVO, "8"));
		list.emplace_back(std::make_unique<SkillLevelAbility>(L"Brawling Prowess Lv.5", L"Gauntlets", SL::APLUS, WEAPONTYPE::GAUNTLETS, L"Grants Hit +10, Avoid +20 and Critical Evade +10 when brawling", true, STATTYPE::HIT, "10", STATTYPE::AVO, "20", STATTYPE::CRITAVO, "10"));
		...
		list.emplace_back(std::make_unique<SkillLevelAbility>(L"Reason Prowess Lv.1", L"Reason", SL::EPLUS, WEAPONTYPE::REASON, L"Grants Hit +7, Avoid +5 and Critical Evade +5 when equipped with Reason Magic", true, STATTYPE::HIT, "7", STATTYPE::AVO, "5", STATTYPE::CRITAVO, "5"));
		list.emplace_back(std::make_unique<SkillLevelAbility>(L"Reason Prowess Lv.2", L"Reason", SL::DPLUS, WEAPONTYPE::REASON, L"Grants Hit +10, Avoid +6 and Critical Evade +6 when equipped with Reason Magic", true, STATTYPE::HIT, "10", STATTYPE::AVO, "6", STATTYPE::CRITAVO, "6"));
		list.emplace_back(std::make_unique<SkillLevelAbility>(L"Reason Prowess Lv.3", L"Reason", SL::CPLUS, WEAPONTYPE::REASON, L"Grants Hit +13, Avoid +7 and Critical Evade +7 when equipped with Reason Magic", true, STATTYPE::HIT, "13", STATTYPE::AVO, "7", STATTYPE::CRITAVO, "7"));
		list.emplace_back(std::make_unique<SkillLevelAbility>(L"Reason Prowess Lv.4", L"Reason", SL::BPLUS, WEAPONTYPE::REASON, L"Grants Hit +16, Avoid +8 and Critical Evade +8 when equipped with Reason Magic", true, STATTYPE::HIT, "16", STATTYPE::AVO, "8", STATTYPE::CRITAVO, "8"));
		list.emplace_back(std::make_unique<SkillLevelAbility>(L"Reason Prowess Lv.5", L"Reason", SL::APLUS, WEAPONTYPE::REASON, L"Grants Hit +20, Avoid +10 and Critical Evade +10 when equipped with Reason Magic", true, STATTYPE::HIT, "20", STATTYPE::AVO, "10", STATTYPE::CRITAVO, "10"));
		...
		list.emplace_back(std::make_unique<SkillLevelAbility>(L"Faith Prowess Lv.1", L"Faith", SL::EPLUS, WEAPONTYPE::FAITH, L"Grants Hit +5, Avoid +7 and Critical Evade +5 when equipped with Faith Magic", true, STATTYPE::HIT, "5", STATTYPE::AVO, "7", STATTYPE::CRITAVO, "5"));
		list.emplace_back(std::make_unique<SkillLevelAbility>(L"Faith Prowess Lv.2", L"Faith", SL::DPLUS, WEAPONTYPE::FAITH, L"Grants Hit +6, Avoid +10 and Critical Evade +6 when equipped with Faith Magic", true, STATTYPE::HIT, "6", STATTYPE::AVO, "10", STATTYPE::CRITAVO, "6"));
		list.emplace_back(std::make_unique<SkillLevelAbility>(L"Faith Prowess Lv.3", L"Faith", SL::CPLUS, WEAPONTYPE::FAITH, L"Grants Hit +7, Avoid +13 and Critical Evade +7 when equipped with Faith Magic", true, STATTYPE::HIT, "7", STATTYPE::AVO, "13", STATTYPE::CRITAVO, "7"));
		list.emplace_back(std::make_unique<SkillLevelAbility>(L"Faith Prowess Lv.4", L"Faith", SL::BPLUS, WEAPONTYPE::FAITH, L"Grants Hit +8, Avoid +16 and Critical Evade +8 when equipped with Faith Magic", true, STATTYPE::HIT, "8", STATTYPE::AVO, "16", STATTYPE::CRITAVO, "8"));
		list.emplace_back(std::make_unique<SkillLevelAbility>(L"Faith Prowess Lv.5", L"Faith", SL::APLUS, WEAPONTYPE::FAITH, L"Grants Hit +10, Avoid +20 and Critical Evade +10 when equipped with Faith Magic", true, STATTYPE::HIT, "10", STATTYPE::AVO, "20", STATTYPE::CRITAVO, "10"));
