...
public:
	BlankAbility() {}
	BlankAbility(std::wstring uName, std::wstring uSource, SL uLevel, SKILLTYPE uST, std::wstring uDescription) : sl(uLevel), st(uST), Ability{ uName, uSource, uDescription } {}
	~BlankAbility() {}
